...
1. Tải `MODOROClaw Setup.exe` từ [Releases](https://github.com/modoro-digital/MODOROClaw/releases)
...
- Output filter (chặn leak API keys, file paths, CoT tiếng Anh)
...
npm install
npm run build:win
# Output: dist/MODOROClaw Setup X.X.X.exe (~360 MB)
```
...
MIT · MODORO Tech Corp · [modoro-digital/MODOROClaw](https://github.com/modoro-digital/MODOROClaw)
