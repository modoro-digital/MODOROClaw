...
// Use this helper when slide content comes from a JSON file generated by another step.
// It strips a UTF-8 BOM so JSON.parse does not fail on files saved by Windows tools.
