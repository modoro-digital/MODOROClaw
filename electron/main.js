...
function createWindow() {
  ...
  // Register ready-to-show BEFORE any early return so
...
function installEmbedHeaderStripper() {
  try {
    ...
    // setWindowOpenHandler is a webContents method — hook via web-contents-created.
...
app.whenReady().then(async () => {
  ...
  // - Runtime installer downloads everything on first launch.
  let splashWindow;
