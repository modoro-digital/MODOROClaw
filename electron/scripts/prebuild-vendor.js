...
const SHARED_VERSIONS = (() => {
  try {
    ...
    return { openclaw: '2026.4.14', openzca: '0.1.57', nineRouter: '0.4.63', node: '22.22.2' };
  }
})();
...
function packVendorForPackagedApp() {
  ...
  // Keep vendor/ after packing. The large runtime payload ships through
  // vendor-bundle.tar. Keeping the local directory lets smoke tests verify
  // package contents and prevents build scripts from deleting tracked
...
async function main() {
  ...
  // Both win32 and darwin reach here (other platforms exit early at top of main).
