...
sections.push(
  ...
  p('Bao gồm: smoke-test.js (45 sections), 8 auxiliary smoke tests, prebuild-vendor.js, fix-better-sqlite3.js, fix-artifact-name.js, và các RAG benchmark scripts.'),
...
sections.push(
  ...
  bullet('7. powerSaveBlocker.start("prevent-app-suspension") — chống Mac App Nap'),
  bullet('8. Power monitor listeners (resume/suspend)'),
  bullet('9. ensureZaloPlugin() — fire-and-forget'),
  bullet('10. Knowledge folders + index rewrite + backfill'),
  bullet('11. enforceRetentionPolicies() + 6h interval'),
  bullet('12. startChannelStatusBroadcast()'),
  bullet('13. startKnowledgeSearchServer() — port 20129'),
  bullet('14. startFastWatchdog() — 30s delay, sau đó 20s interval'),
