...
const _outputFilterPatterns = [
  ...
  // Layer J: raw API/HTTP errors — the LLM sometimes echoes the upstream error
  // verbatim instead of translating it to a friendly message. These patterns
  // catch the entire class of API error leaks, not just specific providers.
  // Observed: "401 [codex/gpt-5.4] [401]: { "error": { "message": "Provided
  ...
  // Layer L: tool approval leak — bot asks customer to approve exec/tool calls
